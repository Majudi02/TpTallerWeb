/*
    ...
    (4, 111, 'Calzone de Jamón y Queso', 'Empanada de pizza rellena con jamón y mozzarella.', '/assets/imagenesPlatos/ab8ec4d2-3e8c-4f7f-9a75-d9bd0ff58c43.jpg', 11.50, 900, 28, 30, 90),
    (5, 111, 'Ensalada Caprese', 'Tomate, mozzarella fresca, albahaca y aceite de oliva.', '/assets/imagenesPlatos/e2a78c0f-8593-4032-8157-e3a1a2f556fd.jpg', 7.00, 350, 15, 20, 10),
    (6, 111, 'Focaccia de Romero', 'Pan focaccia con aceite de oliva y romero fresco.', '/assets/imagenesPlatos/316e3d83-9305-41cc-a425-14cd88433a3e.jpg', 6.50, 450, 8, 15, 60);
    ...
    (10, 112, 'Penne Arrabiata', 'Pasta penne con salsa picante de tomate y ajo.', '/assets/imagenesPlatos/dbbf529d-3d9b-48f6-ae4f-c207b3573da2.jpg', 13.00, 650, 18, 20, 85),
    (11, 112, 'Tiramisu', 'Postre italiano con café, queso mascarpone y cacao.', '/assets/imagenesPlatos/77c63d9b-dc3b-46a7-a1e6-40e6bd8e2538.jpg', 7.50, 450, 7, 30, 40),
    (12, 112, 'Gnocchi de Papa', 'Bolitas de papa con salsa de tomate y albahaca.', '/assets/imagenesPlatos/f639733c-6289-4d4f-bcd1-f1a7c710ea36.jpg', 14.00, 600, 15, 20, 90);
    ...
    (16, 113, 'Tempura de Vegetales', 'Verduras rebozadas y fritas al estilo japonés.', '/assets/imagenesPlatos/6c544eaa-8bb9-44b9-ae01-352d40b41417.jpg', 10.00, 400, 10, 25, 45),
    (17, 113, 'Sushi Veggie Roll', 'Roll con palta, pepino, zanahoria y arroz.', '/assets/imagenesPlatos/ca7e99e7-849e-4f03-a719-544c3a6e2c31.jpg', 11.00, 350, 8, 10, 50),
    (18, 113, 'Miso Soup', 'Sopa tradicional japonesa de miso y algas.', '/assets/imagenesPlatos/06f96b41-79af-4596-9c36-b36b3f1c7497.jpg', 5.00, 100, 5, 3, 12);
    INSERT IGNORE INTO Plato_Etiqueta (plato_id, etiqueta_id) VALUES
    (13, 3),
    (13, 4),
    (15, 3),
    ...
    (22, 114, 'Quesadilla de Queso', 'Tortilla rellena de queso derretido, servida con salsa.', '/assets/imagenesPlatos/bcf735cc-052d-4b4f-8e64-48d005f34a7c.jpg', 9.00, 450, 15, 25, 40),
    (23, 114, 'Sopa de Tortilla', 'Caldo de tomate con tiras de tortilla frita y aguacate.', '/assets/imagenesPlatos/802dbe75-53a5-47ac-9bbf-7cb91e094bd2.jpg', 7.50, 350, 10, 18, 30),
    (24, 114, 'Churros con Chocolate', 'Churros crujientes con salsa de chocolate.', '/assets/imagenesPlatos/dad4c90f-aeb9-478b-b674-4b3e0cb0b510.jpg', 6.00, 500, 5, 30, 60);
    INSERT IGNORE INTO Plato_Etiqueta (plato_id, etiqueta_id) VALUES
    (21, 1),
    (21, 4),
    (22, 2),
    ...
    (28, 115, 'Ratatouille', 'Guiso de verduras provenzal con hierbas aromáticas.', '/assets/imagenesPlatos/ff7c876f-5c3e-4b5f-ae02-32a8943e99fe.jpg', 13.00, 350, 8, 15, 30),
    (29, 115, 'Quiche Lorraine', 'Tarta salada con huevo, crema, bacon y queso.', '/assets/imagenesPlatos/26a347be-f5c6-4c50-95a3-96c9643189b1.jpg', 12.50, 600, 25, 35, 40),
    (30, 115, 'Madeleines', 'Pequeños bizcochos franceses con forma de concha.', '/assets/imagenesPlatos/69fc8a95-8bd2-4045-ae6a-1b537c8f105b.jpg', 6.00, 300, 4, 18, 35);
    INSERT IGNORE INTO Plato_Etiqueta (plato_id, etiqueta_id) VALUES
    (26, 3),
    (28, 1),
    (29, 3),
    ...
    (34, 116, 'Papas Fritas', 'Papas cortadas a mano y fritas hasta dorar.', '/assets/imagenesPlatos/17e58063-5f39-4fcb-ae58-1f71d2b29f89.jpg', 5.00, 400, 5, 20, 45),
    (35, 116, 'Aros de Cebolla', 'Aros crujientes de cebolla empanizados y fritos.', '/assets/imagenesPlatos/e338f468-d2ad-4645-b6b3-cd0d2adf1ab9.jpg', 6.00, 350, 3, 15, 40),
    (36, 116, 'Batido de Vainilla', 'Batido cremoso de vainilla con helado y leche.', '/assets/imagenesPlatos/b370fe09-7584-40d1-a6df-8137800a1b6b.jpg', 4.50, 300, 6, 10, 35);
    ...
    (40, 117, 'Hummus con Pan Pita', 'Puré de garbanzos con tahini, limón y ajo, servido con pan pita.', '/assets/imagenesPlatos/9f4f6d69-a0f3-4bcd-816a-31f4d1dc1d29.jpg, 8.50, 300, 10, 15, 30),
    (41, 117, 'Falafel', 'Croquetas de garbanzo fritas con especias y hierbas.', '/assets/imagenesPlatos/2405816e-4117-4532-b1df-c75bb281e72a.jpg', 9.00, 350, 15, 12, 35),
    (42, 117, 'Tabulé', 'Ensalada fresca de trigo bulgur con perejil, tomate y limón.', '/assets/imagenesPlatos/e8de2e3d-c66e-41b2-8189-b342f23e42c9.jpg', 10.00, 250, 8, 6, 25);
    INSERT IGNORE INTO Plato_Etiqueta (plato_id, etiqueta_id) VALUES
    (37, 1),
    (37, 2),
    (37, 3),
