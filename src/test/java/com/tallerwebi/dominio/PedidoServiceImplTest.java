 ...
 */
   ...
   List<PlatoDto> platos = List.of(
    new PlatoDto(1, 1L, "Milanesa con papas fritas", "Clásica milanesa...", "/assets/imagen-plato.png", 2500.0, List.of(new EtiquetaDto(1, "Proteica")), 0.0, 0.0, 0.0, 0.0,null),
    new PlatoDto(2, 1L, "Ravioles de ricota", "Ravioles caseros...", "/assets/imagen-plato.png", 2800.0, List.of(new EtiquetaDto(2, "Vegetariana")), 0.0, 0.0, 0.0, 0.0,null),
    new PlatoDto(3, 1L, "Pizza napolitana", "Pizza con tomate...", "/assets/imagen-plato.png", 3200.0, List.of(new EtiquetaDto(2, "Vegetariana")), 0.0, 0.0, 0.0, 0.0,null),
    new PlatoDto(4, 1L, "Hamburguesa completa", "Hamburguesa con lechuga...", "/assets/imagen-plato.png", 2900.0, List.of(new EtiquetaDto(1, "Proteica")), 0.0, 0.0, 0.0, 0.0,null),
    new PlatoDto(5, 1L, "Ensalada César", "Ensalada con lechuga...", "/assets/imagen-plato.png", 2300.0, List.of(new EtiquetaDto(1, "Proteica")), 0.0, 0.0, 0.0,0.0 ,null),
    new PlatoDto(6, 1L, "Tarta de espinaca", "Tarta casera...", "/assets/imagen-plato.png", 2000.0, List.of(new EtiquetaDto(2, "Vegetariana")), 0.0, 0.0, 0.0, 0.0,null)
);
    ...
    public void DadoQueExistenDiezPlatosConLaEtiquetaProteicaObtengoSoloLosDelTipoDeComidaFiltrada() {
        List<PlatoDto> platosTotales = List.of(
                new PlatoDto(1, 1L, "Milanesa con papas fritas", "...", "/d2f8a6e1-a7c3-4f09-8f7b-2cd1c3b63a88.jpg", 2500.0, List.of(new EtiquetaDto(1, "Proteica")), 600.0, 45.0, 25.0, 50.0, null),
                new PlatoDto(2, 1L, "Ravioles de ricota", "...", "/d2f8a6e1-a7c3-4f09-8f7b-2cd1c3b63a88.jpg", 2800.0, List.of(new EtiquetaDto(2, "Vegetariana")), 550.0, 30.0, 20.0, 60.0, null),
                new PlatoDto(3, 1L, "Pizza napolitana", "...", "/d2f8a6e1-a7c3-4f09-8f7b-2cd1c3b63a88.jpg", 3200.0, List.of(new EtiquetaDto(2, "Vegetariana")), 700.0, 25.0, 30.0, 70.0, null),
                new PlatoDto(4, 1L, "Hamburguesa completa", "...", "/d2f8a6e1-a7c3-4f09-8f7b-2cd1c3b63a88.jpg", 2900.0, List.of(new EtiquetaDto(1, "Proteica")), 650.0, 40.0, 35.0, 45.0, null),
                new PlatoDto(5, 1L, "Ensalada César", "...", "/d2f8a6e1-a7c3-4f09-8f7b-2cd1c3b63a88.jpg", 2300.0, List.of(new EtiquetaDto(1, "Proteica")), 400.0, 20.0, 15.0, 30.0, null),
                new PlatoDto(6, 1L, "Tarta de espinaca", "...", "/d2f8a6e1-a7c3-4f09-8f7b-2cd1c3b63a88.jpg", 2000.0, List.of(new EtiquetaDto(2, "Vegetariana")), 450.0, 18.0, 22.0, 40.0, null),
                new PlatoDto(7, 1L, "Lasaña de carne", "...", "/d2f8a6e1-a7c3-4f09-8f7b-2cd1c3b63a88.jpg", 3100.0, List.of(new EtiquetaDto(1, "Proteica")), 680.0, 50.0, 28.0, 55.0, null),
                new PlatoDto(8, 1L, "Empanadas salteñas", "...", "/d2f8a6e1-a7c3-4f09-8f7b-2cd1c3b63a88.jpg", 1800.0, List.of(new EtiquetaDto(1, "Proteica")), 520.0, 35.0, 18.0, 45.0, null),
                new PlatoDto(9, 1L, "Pollo al horno con papas", "...", "/d2f8a6e1-a7c3-4f09-8f7b-2cd1c3b63a88.jpg", 2600.0, List.of(new EtiquetaDto(1, "Proteica")), 600.0, 42.0, 20.0, 50.0, null),
                new PlatoDto(10, 1L, "Tacos de carne", "...", "/d2f8a6e1-a7c3-4f09-8f7b-2cd1c3b63a88.jpg", 3000.0, List.of(new EtiquetaDto(1, "Proteica")), 700.0, 48.0, 30.0, 60.0, null)
        );
    ...
    public void DadoQueExistenDiezPlatosConLaEtiquetaProteicaLosQuieroOrdenarDeMenorAMayor() {
        List<PlatoDto> platosTotales = List.of(
                ...
                new PlatoDto(9, 1L, "Pollo al horno con papas", "...", "/d2f8a6e1-a7c3-4f09-8f7b-2cd1c3b63a88.jpg", 2600.0, List.of(new EtiquetaDto(1, "Proteica")), 600.0, 42.0, 20.0, 50.0,null),
                new PlatoDto(10, 1L, "Tacos de carne", "...", "/d2f8a6e1-a7c3-4f09-8f7b-2cd1c3b63a88.jpg", 3000.0, List.of(new EtiquetaDto(1, "Proteica")), 700.0, 48.0, 30.0, 60.0,null),
                new PlatoDto(13, 1L, "Milanesa napolitana", "...", "/d2f8a6e1-a7c3-4f09-8f7b-2cd1c3b63a88.jpg", 3200.0, List.of(new EtiquetaDto(1, "Proteica")),700.0, 48.0, 35.0, 55.0,null),
                new PlatoDto(16, 1L, "Churrasco", "...", "/d2f8a6e1-a7c3-4f09-8f7b-2cd1c3b63a88.jpg", 3500.0, List.of(new EtiquetaDto(1, "Proteica")),650.0, 50.0, 30.0, 40.0,null),
                new PlatoDto(18, 1L, "Sándwich de lomito", "...", "/d2f8a6e1-a7c3-4f09-8f7b-2cd1c3b63a88.jpg", 2800.0, List.of(new EtiquetaDto(1, "Proteica")),600.0, 45.0, 25.0, 50.0,null)
        );
